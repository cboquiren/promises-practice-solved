...
// Your code goes here...
export const handlePromise2 = (arr) => Promise.any(arr).then(data => data);
...
// Your code goes here...
export const handlePromise3 = (arr) => Promise.allSettled(arr).then(data => data).catch(e => e.message);
...
export const newPromiseArr = promiseArr.filter((promise, index) => index === promiseArr.length - 1);
